...
}catch(b){return null;}if(e){if(Components.interfaces.nsISupportsWString){e=e.value.QueryInterface(Components.interfaces.nsISupportsWString);}else{if(Components.interfaces.nsISupportsString){e=e.value.QueryInterface(Components.interfaces.nsISupportsString);}else{e=null;}}}if(e){return(e.data.substring(0,a.value/2));}}}return null;}function copyToClipboard(b){if(window.clipboardData){window.clipboardData.clearData();window.clipboardData.setData("Text",b);}else{if(navigator.userAgent.indexOf("Opera")!=-1){window.location=b;}else{if(window.netscape){try{netscape.security.PrivilegeManager.enablePrivilege("UniversalXPConnect");}catch(g){alert("被浏览器拒绝！\n请在浏览器地址栏输入'about:config'并回车\n然后将'signed.applets.codebase_principal_support'设置为'true'");}var d=Components.classes["@mozilla.org/widget/clipboard;1"].createInstance(Components.interfaces.nsIClipboard);if(!d){return;}var c=Components.classes["@mozilla.org/widget/transferable;1"].createInstance(Components.interfaces.nsITransferable);if(!c){return;}c.addDataFlavor("text/unicode");var h=new Object();var a=new Object();var h=Components.classes["@mozilla.org/supports-string;1"].createInstance(Components.interfaces.nsISupportsString);var i=b;h.data=i;c.setTransferData("text/unicode",h,i.length*2);var f=Components.interfaces.nsIClipboard;if(!d){return false;}d.setData(c,null,f.kGlobalClipboard);}}}}function fixFlexArray(c){var a=[];for(var b in c){a[b*1]=c[b];}return a;}function getBirthday(d){var a,b;if(d.length==18){a=d.substring(6,14);}else{if(d.length==15){b=d.substring(6,12);a="19"+b;}else{return"";}}var c=a.substring(0,4)+"-"+a.substring(4,6)+"-"+a.substring(6,8);return c;}function getSex(d){var b,c;if(d.length==18){b=d.substring(16,17);}else{if(d.length==15){b=d.substring(14,15);}else{return"";}}var a=b%2;if(a==0){c="女";}else{c="男";}return c;}function isBrowseScale(){var c=0,a=window.screen,b=navigator.userAgent.toLowerCase();if(isFirefor()){if(window.devicePixelRatio!==undefined){c=window.devicePixelRatio;}}else{if(isIE()){if(a.deviceXDPI&&a.logicalXDPI){c=a.deviceXDPI/a.logicalXDPI;}}else{if(window.outerWidth!==undefined&&window.innerWidth!==undefined){c=window.outerWidth/window.innerWidth;}}}if(c){c=Math.round(c*100);}if(c!==100){if(c>=98&&c<=102){c=100;}}return c!=100;}function openWindow(a,b){var d=window.open("",a);var c=d.document;c.write(b);c.close();}function flashChecker(){var a=0;var b=0;if(isIE()){var d=new ActiveXObject("ShockwaveFlash.ShockwaveFlash");if(d){a=1;VSwf=d.GetVariable("$version");b=parseInt(VSwf.split(" ")[1].split(",")[0]);}}else{if(navigator.plugins&&navigator.plugins.length>0){var d=navigator.plugins["Shockwave Flash"];if(d){a=1;var e=d.description.split(" ");for(var c=0;c<e.length;++c){if(isNaN(parseInt(e[c]))){continue;}b=parseInt(e[c]);}}}}return{f:a,v:b};}function favorite_home(){var a=window.location.href;a=a.substr(0,a.lastIndexOf("/"));a=a.substr(0,a.lastIndexOf("/"));a=a+"/index.jsp";window.external.addFavorite(a,VAR_DOCUMENT_TITLE);}var PORTAL={};PORTAL.getParams=function(){return top.INTF_PORTALGRIDEX.getParams(__portalid__);};PORTAL.LAYOUT={};PORTAL.LAYOUT.A=function(){return top.INTF_PORTALGRIDEX.LAYOUT.get(__portalid__,"a");};PORTAL.LAYOUT.B=function(){return top.INTF_PORTALGRIDEX.LAYOUT.get(__portalid__,"b");};PORTAL.LAYOUT.C=function(){return top.INTF_PORTALGRIDEX.LAYOUT.get(__portalid__,"c");};PORTAL.LAYOUT.get=function(a){return top.INTF_PORTALGRIDEX.LAYOUT.get(__portalid__,a);};PORTAL.CONTROL={};PORTAL.CONTROL.getRootId=function(a){return top.INTF_PORTALGRIDEX.CONTROL.getRootId(__portalid__,a);};PORTAL.CONTROL.getSelectedItem=function(a){return top.INTF_PORTALGRIDEX.CONTROL.getSelectedItem(__portalid__,a);};PORTAL.CONTROL.getSelectedItems=function(a){return top.INTF_PORTALGRIDEX.CONTROL.getSelectedItems(__portalid__,a);};PORTAL.CONTROL.append=function(b,a){return top.INTF_PORTALGRIDEX.CONTROL.append(__portalid__,b,a);};PORTAL.CONTROL.edit=function(a){return top.INTF_PORTALGRIDEX.CONTROL.edit(__portalid__,a);};PORTAL.CONTROL.viewform=function(a){return top.INTF_PORTALGRIDEX.CONTROL.viewform(__portalid__,a);};PORTAL.CONTROL.del=function(a){return top.INTF_PORTALGRIDEX.CONTROL.del(__portalid__,a);
};PORTAL.CONTROL.up=function(a){return top.INTF_PORTALGRIDEX.CONTROL.up(__portalid__,a);};PORTAL.CONTROL.down=function(a){return top.INTF_PORTALGRIDEX.CONTROL.down(__portalid__,a);};PORTAL.CONTROL.refresh=function(a){return top.INTF_PORTALGRIDEX.CONTROL.refresh(__portalid__,a);};PORTAL.CONTROL.getRecords=function(a){return top.INTF_PORTALGRIDEX.CONTROL.getRecords(__portalid__,a);};PORTAL.CONTROL.update=function(b,a){return top.INTF_PORTALGRIDEX.CONTROL.updateRecord(__portalid__,b,a);};PORTAL.CONTROL.selectItem=function(b,a){return top.INTF_PORTALGRIDEX.CONTROL.selectItem(__portalid__,b,a);};PORTAL.CONTROL.refreshSelectedItem=function(a){return top.INTF_PORTALGRIDEX.CONTROL.refreshSelectedItem(__portalid__,a);};PORTAL.CONTROL.firstPage=function(a){return top.INTF_PORTALGRIDEX.CONTROL.firstPage(__portalid__,a);};PORTAL.CONTROL.lastPage=function(a){return top.INTF_PORTALGRIDEX.CONTROL.lastPage(__portalid__,a);};PORTAL.CONTROL.callLater=function(b,a){if(typeof(a)=="function"){window["__"+b+"callLaterFunName__"]=a;a="__"+b+"callLaterFunName__";}return top.INTF_PORTALGRIDEX.CONTROL.callLater(__portalid__,b,a);};PORTAL.CONTROL.callFunction=function(b,a,c){return top.INTF_PORTALGRIDEX.CONTROL.executeSWFControlFunction(__portalid__,b,a,c);};PORTAL.CONTROL.saveToServer=function(a){return top.INTF_PORTALGRIDEX.CONTROL.saveToServer(__portalid__,a);};PORTAL.CONTROL.setDiagramActionBackground=function(c,a,b){return top.INTF_PORTALGRIDEX.CONTROL.setDiagramActionBackground(__portalid__,c,a,b);};PORTAL.CONTROL.focusDiagramActions=function(a,b){return top.INTF_PORTALGRIDEX.CONTROL.focusDiagramActions(__portalid__,a,b);};PORTAL.CONTROL.loadDiagram=function(b,a){return top.INTF_PORTALGRIDEX.CONTROL.loadDiagram(__portalid__,b,a);};PORTAL.CONTROL.setDiagramActionStep=function(c,a,b){return top.INTF_PORTALGRIDEX.CONTROL.setDiagramActionStep(__portalid__,c,b);};PORTAL.CONTROL.setDiagramActionSetting=function(d,a,b,c){return top.INTF_PORTALGRIDEX.CONTROL.setDiagramActionSetting(__portalid__,d,b,c);};PORTAL.CONTROL.batchSetDiagramActionSettings=function(a,b){return top.INTF_PORTALGRIDEX.CONTROL.batchSetDiagramActionSettings(__portalid__,a,b);};PORTAL.CONTROL.getDiagramActionSettings=function(a){return top.INTF_PORTALGRIDEX.CONTROL.getDiagramActionSettings(__portalid__,a);};PORTAL.CONTROL.setActivePage=function(b,a){return top.INTF_PORTALGRIDEX.CONTROL.setActivePage(__portalid__,b,a);};PORTAL.CONTROL.setContent=function(b,a){return top.INTF_PORTALGRIDEX.CONTROL.setContent(__portalid__,b,a);};PORTAL.CONTROL.getContent=function(a){return top.INTF_PORTALGRIDEX.CONTROL.getContent(__portalid__,a);};PORTAL.CONTROL.setRichViewText=function(b,c,a){return top.INTF_PORTALGRIDEX.CONTROL.setRichViewText(__portalid__,b,c,a);};PORTAL.CONTROL.getRichViewText=function(b,a){return top.INTF_PORTALGRIDEX.CONTROL.getRichViewText(__portalid__,b,a);};PORTAL.CONTROL.addGeometry=function(a,b){return top.INTF_PORTALGRIDEX.CONTROL.addGeometry(__portalid__,a,b);};PORTAL.CONTROL.setFormParams=function(a,b){return top.INTF_PORTALGRIDEX.CONTROL.setFormParams(__portalid__,a,b);};PORTAL.CONTROL.setRecordId=function(b,a){return top.INTF_PORTALGRIDEX.CONTROL.setRecordId(__portalid__,b,a);};PORTAL.CONTROL.getParams=function(a){return top.INTF_PORTALGRIDEX.CONTROL.getParams(__portalid__,a);};PORTAL.CONTROL.setFilterParams=function(a,b){return top.INTF_PORTALGRIDEX.CONTROL.setFilterParams(__portalid__,a,b);};PORTAL.CONTROL.setReadonly=function(b,a){return top.INTF_PORTALGRIDEX.CONTROL.setReadonly(__portalid__,b,a);};PORTAL.DB={};PORTAL.DB.getServerUniqueId=function(){return top.GLOBAL.DB.getServerUniqueid();};PORTAL.DB.getSerialCode=function(a){return top.GLOBAL.DB.getSerialCode(a);};PORTAL.DB.getDataSetJson=function(a,b){return top.GLOBAL.DB.getLookupDatasetJson(__portalid__,a,b);};PORTAL.DB.lookupDataSet=function(f,g,e,b,c,a,d){if(typeof(e)=="function"){window.__gridDataSetCallbackFunction__=e;e="__gridDataSetCallbackFunction__";}top.GLOBAL.DB.gridDataSet(__portalid__,f,g,e,b,c,a,d,"PORTALGRID_"+__portalid__);};PORTAL.DB.executeDataSet=function(a,b){return top.GLOBAL.DB.executeSQL(__portalid__,a,b);
};PORTAL.DB.batchExecuteDataSet=function(a,b){return top.GLOBAL.DB.batchExecuteSQL(__portalid__,a,b);};PORTAL.DB.treeDataSet=function(g,h,f,d,a,e,b,c){if(typeof(f)=="function"){window.__treeDataSetCallbackFunction__=f;f="__treeDataSetCallbackFunction__";}return top.GLOBAL.DB.treeDataSet(__portalid__,g,h,f,d,a,e,"PORTALGRID_"+__portalid__,"","",{datasetName:g,selectedValues:b,portalId:__portalid__},c);};PORTAL.UTILS={};PORTAL.UTILS.sendMessage=function(a,b){return top.GLOBAL.UTILS.sendMobileMessage(a,b);};PORTAL.executePortalFunction=top.GLOBAL.executePortalFunction;PORTAL.EXCEL={};PORTAL.EXCEL.downTemplate=function(d,b,a,e){if(isNaN(a)){a=0;}if(isNaN(e)){e=0;}var c={sheetName:d,header:[{row:a,startCol:e,items:b}]};top.downloadExcelTemplate(ExcelTemplateDefine);};PORTAL.EXCEL.importExcel=function(c,f,b,d,j,e,i,a){if(isNaN(i)){i=0;}if(isNaN(a)){a=0;}var h={portalID:__portalid__,execute:[{sheetName:b,datasetName:c,firstRow:i+1,firstCol:a,params2Col:j}]};var g={sheetName:b,header:[{row:i,startCol:a,items:d}]};if(typeof(e)=="function"){window.__flexUploadExcelCallbackFunction__=e;e="__flexUploadExcelCallbackFunction__";}top.uploadExcelTemplate($.toJSON(h),$.toJSON(g),f,e,"PORTALGRID_"+__portalid__);};PORTAL.EXCEL.exportExcel=function(d,g,a,c,h,e,j,b){if(isNaN(j)){j=0;}if(isNaN(b)){b=0;}var i=[];i.push({sheetName:c,datasetName:d,firstRow:j,firstCol:b,fields:h,headers:e});var f={filename:a,portalID:__portalid__,execute:i};top.exportToExcel(f,g);};PORTAL.EXCEL.jsonTemplate2Excel=function(d){var c={define:$.toJSON(d),o:"jsonTemplate2Excel"};var b="../client/excelservlet";var a=null;$.post(b,c,function(g){var e=$.evalJSON(g);var f=e.url;GLOBAL.OpenURL(f);}).fail(function(){GLOBAL.popupMessage("系统","同服务器连接超时(网速太慢),请检查网络后重试！",true);a=AJAX_ERROR_MSG;});return a;};PORTAL.WINDOW={};PORTAL.WINDOW.listDataSet=PORTAL.DB.listDataSet;PORTAL.WINDOW.treeDataSet=PORTAL.DB.treeDataSet;PORTAL.WINDOW.selectDate=function(a){if(typeof(a)=="function"){window.__flexSelectedDateCallbackFunction__=a;a="__flexSelectedDateCallbackFunction__";}top.GLOBAL.UTILS.selectDate("PORTALGRID_"+__portalid__,a);};PORTAL.WINDOW.modalDialog=function(d,c,b,g,f,a,h){var e=top.getFomrsSize(d);if(typeof(f)=="function"){window.__modalDialogCallbackFunction__=f;f="__modalDialogCallbackFunction__";}if(typeof(a)=="function"){window.__modalDialogCloseCallbackFunction__=a;a="__modalDialogCloseCallbackFunction__";}if((typeof a)=="boolean"){h=a;a="";}top.GLOBAL.WIN.modalDialog(d,e.w,e.h,c,b,g,f,a,"PORTALGRID_"+__portalid__,h);};PORTAL.WINDOW.closeDialog=function(a){top.GLOBAL.WIN.closeDialog(a);};PORTAL.WINDOW.saveFormDialog=function(a){top.GLOBAL.WIN.saveFormDialog(a);};var GLOBAL={};GLOBAL.flexAlert=top.GLOBAL.UTILS.flexAlert;GLOBAL.flexConfirm=function(c,b,a){if(!a){a="";}if(typeof(b)=="function"){window.__flexConfirmCallbackFunction__=b;b="__flexConfirmCallbackFunction__";}if(typeof(a)=="function"){window.__flexConfirmCallbackCancelFunction__=a;a="__flexConfirmCallbackCancelFunction__";}top.GLOBAL.UTILS.flexConfirm(c,b,a,"PORTALGRID_"+__portalid__);};GLOBAL.moduleSWFDialog=function(b,d,a,c,f,e){if(typeof(e)=="function"){window.__flexModuleSWFDialogCallbackFunction__=e;e="__flexModuleSWFDialogCallbackFunction__";}top.GLOBAL.WIN.moduleSWFDialog(b,d,a,c,f,"PORTALGRID_"+__portalid__,e);};GLOBAL.OpenURL=top.GLOBAL.UTILS.OpenURL;GLOBAL.goURL=top.GLOBAL.UTILS.OpenURL;GLOBAL.USERINFO={id:top.INTF_ENVIRONMENT.USERID,name:top.INTF_ENVIRONMENT.REALNAME};GLOBAL.INTF_ENVIRONMENT=top.INTF_ENVIRONMENT;PORTAL.WINDOW.goURL=top.GLOBAL.UTILS.OpenURL;GLOBAL.WINDOW=PORTAL.WINDOW;GLOBAL.PRINT=top.GLOBAL.PRINT;GLOBAL.gotoPortal=top.GLOBAL.gotoPortal;GLOBAL.closePortal=top.GLOBAL.closePortal;GLOBAL.executePortalFunction=top.GLOBAL.executePortalFunction;GLOBAL.STORAGE=top.GLOBAL.STORAGE;GLOBAL.UTILS=top.GLOBAL.UTILS;GLOBAL.popupMessage=top.GLOBAL.popupMessage;GLOBAL.commonWords=function(b,c,a){if(typeof(c)=="function"){window.__flexModuleCOMMONWordsFunction__=c;c="__flexModuleCOMMONWordsFunction__";}return top.GLOBAL.commonWords(b,"PORTALGRID_"+__portalid__,c,a);};OPUTILS={};OPUTILS.sendMsm=function(a,b){return top.GLOBAL.UTILS.sendMobileMessage(a,b);
};OPUTILS.sendEmail=function(a,b,c){return top.GLOBAL.UTILS.sendEmail(a,b,c);};function SendSMS(a,b){return top.GLOBAL.UTILS.sendMobileMessage(a,b);}function downAttachment(paramsStr){eval("url = "+paramsStr);GLOBAL.goURL("/attachment/"+url);}function executeOtherCallmeFunction(){var f=top.getCallPortalFunctionParams(getFrameID());if(f){var a=f[0].split(".");var d=f[1];var b=window;for(var c=0;c<a.length;c++){var e=a[c];var b=b[e];}if(typeof(b)=="function"){return b(d);}else{return b;}}}var EXCEL={};var dynamicCreateWorkFlowProcess=top.dynamicCreateWorkFlowProcess;var WEBGIS={};WEBGIS.winMap=function(a,c,b,f,e){var d="Map4MIS.swf";GLOBAL.moduleSWFDialog(a,1000,600,d,{mapName:c,initFunction:b,initParams:f,userId:GLOBAL.USERINFO.id},e);};WEBGIS.selectMapFeature=function(b,a,c){WEBGIS.winMap("选取地图实体",b,"showFeature",a,c);};var DHTML4FLEX=top.DHTML4FLEX;function documentOnLoad(){if(window.ON_PORTAL_INITIALIZE){ON_PORTAL_INITIALIZE();}executeOtherCallmeFunction();}