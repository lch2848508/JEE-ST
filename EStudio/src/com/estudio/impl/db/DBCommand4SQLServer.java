...
public class DBCommand4SQLServer extends DBCommand {
     ...
     *             , DBException
     */
    public DBCommand4SQLServer(final Connection connection, final String SQL) throws Exception {
     ...
     *             , DBException
     */
    public DBCommand4SQLServer(final Connection connection, final String SQL, final boolean isSkipParserParams) throws Exception {
    ...
    protected IDBHelper getDBHelper() {
        return DBHelper4SQLServer.getInstance();
    }
}
