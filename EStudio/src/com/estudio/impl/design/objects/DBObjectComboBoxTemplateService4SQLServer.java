...
public final class DBObjectComboBoxTemplateService4SQLServer extends DBObjectComboBoxTemplateService {

    public static DBObjectComboBoxTemplateService4SQLServer getInstance() {
        return instance;
    }

    private static DBObjectComboBoxTemplateService4SQLServer instance = new DBObjectComboBoxTemplateService4SQLServer();

    private DBObjectComboBoxTemplateService4SQLServer() {
        super();
    }
