...
public final class DBSQLParserService4SQLServer extends DBSQLParserService {

    private static final IDBHelper DBHELPER = RuntimeContext.getDbHelper();
    private static DBSQLParserService4SQLServer instance = new DBSQLParserService4SQLServer();

    public static DBSQLParserService4SQLServer getInstance() {
        return instance;
    }

    private DBSQLParserService4SQLServer() {
        super();
    }
    ...
    protected Map<String, String> getTablesFieldComment(final Connection con, final String[] tables) throws Exception {
        ...
        if (tables != null) {
            String sql = "select upper(column_name) N,column_comment C from view_sys_user_tab_columns where UPPER(table_name) in (''";
