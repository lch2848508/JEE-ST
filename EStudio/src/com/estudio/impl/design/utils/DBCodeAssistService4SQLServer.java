...
public final class DBCodeAssistService4SQLServer extends DBCodeAssistService {
    ...
    private static DBCodeAssistService4SQLServer instance = new DBCodeAssistService4SQLServer();

    public static DBCodeAssistService4SQLServer getInstance() {
        return instance;
    }

    private DBCodeAssistService4SQLServer() {
        super();
    }
