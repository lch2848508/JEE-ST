...
public final class DBDepartmentService4SQLServer extends DBDepartmentService {
     ...
     * ¹¹Ôìº¯Êý
     */
    private DBDepartmentService4SQLServer() {
        super();
    }

    private static IDepartmentService instance = new DBDepartmentService4SQLServer();
