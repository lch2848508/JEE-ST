...
public final class DBPortalGroupService4SQLServer extends DBPortalGroupService {
    ...
    private DBPortalGroupService4SQLServer() {
        super();
    }

    private static final DBPortalGroupService4SQLServer INSTANCE = new DBPortalGroupService4SQLServer();

    public static DBPortalGroupService4SQLServer getInstance() {
        return INSTANCE;
    }
