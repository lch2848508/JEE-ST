...
public final class DBPortalItemService4SQLServer extends DBPortalItemService {
    ...
    private static DBPortalItemService4SQLServer instance = new DBPortalItemService4SQLServer();

    public static DBPortalItemService4SQLServer getInstance() {
        return instance;
    }

    private DBPortalItemService4SQLServer() {
        super();
    }
