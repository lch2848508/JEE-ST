...
public final class DBDiagramService4SQLServer extends DBDiagramService {

    private DBDiagramService4SQLServer() {
        super();
    }

    private static final IDBDiagramService INSTANCE = new DBDiagramService4SQLServer();
    ...
    protected String getDBEntrysVersionSQL() {
        return "select a.name,dbo.fun_date_to_bigint(ISNULL(b.modify_date,b.create_date)) from view_sys_user_tables b,sys_db_diagram_item a where upper(a.name)=upper(b.table_name) and a.p_id=?";
    }
