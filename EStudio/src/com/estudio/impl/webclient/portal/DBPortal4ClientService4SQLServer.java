 ...
 * 
 */
public final class DBPortal4ClientService4SQLServer extends DBPortal4ClientService {
    ...
    private DBPortal4ClientService4SQLServer() {
        super();
    }

    private static final DBPortal4ClientService4SQLServer INSTANCE = new DBPortal4ClientService4SQLServer();

    public static DBPortal4ClientService4SQLServer getInstance() {
        return INSTANCE;
    }
