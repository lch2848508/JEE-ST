...
public final class DBPictureService4SQLServer extends DBPictureService {
    ...
    private DBPictureService4SQLServer() {
        super();
    }

    private static final DBPictureService4SQLServer INSTANCE = new DBPictureService4SQLServer();
