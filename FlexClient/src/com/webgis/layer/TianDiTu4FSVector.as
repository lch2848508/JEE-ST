package com.webgis.layer
{
	...
	public class TianDiTu4FSVector extends TiledMapServiceLayer
	{
		...
		public function TianDiTu4FSVector()
		{
			super();
		...
		override protected function getTileURL(level:Number, row:Number, col:Number):URLRequest
		{
			...
			if (level >= 9 && level <= 13)
				urlRequest="http://19.128.104.244:8001/ZWMAP20149TO13/wmts?SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=ZWMAP20149TO13&STYLE=ZWMAP20149TO13&TILEMATRIXSET=Matrix_0&TILEMATRIX=" + level + "&TILEROW=" + row + "&TILECOL=" + col + "&FORMAT=image%2Ftile";
			else if (level >= 14)
				urlRequest="http://19.128.104.244:8001/ZWMAP2014/wmts?SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=ZWMAP2014&STYLE=ZWMAP2014&TILEMATRIXSET=Matrix_0&TILEMATRIX=" + level + "&TILEROW=" + row + "&TILECOL=" + col + "&FORMAT=image%2Ftile";
