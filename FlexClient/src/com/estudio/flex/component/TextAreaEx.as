package com.estudio.flex.component
{
	...
	public class TextAreaEx extends TextArea implements InterfaceEditableControl
	{
		...
		public function set readonly(value:Boolean):void
		{
			if (controlParams.readonly != value)
			{
				...
				this.editable=!controlParams.readonly;
			}
		...
		{
			return EditableControlParams.CONST_MEMO;
		}
